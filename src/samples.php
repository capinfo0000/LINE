...
function seed_sample_members(): int
{
    ...
    $data = [
        ['佐藤 健一', '42', '佐藤テック株式会社 / 代表', 'SaaS開発20年。地方企業のDX支援に注力しています。', 'area|東京', 'job|IT・Web', ['協業', '販路開拓'], ['技術・開発', 'ノウハウ提供'], 6200],
        ['鈴木 美咲', '35', 'ミサキ広告 / プランナー', 'BtoBマーケが得意。良い商品を広めたい方はぜひ。', 'area|大阪', 'job|広告・マーケ', ['顧客紹介', '協業'], ['販路開拓', 'ノウハウ提供'], 900],
        ['髙橋 亮', '48', '髙橋不動産 / 社長', '収益不動産・事業用地のご相談を。投資家仲間募集中。', 'area|福岡', 'job|不動産', ['資金・出資', '情報交換'], ['資金・出資', '顧客紹介'], 13500],
        ['田中 由紀', '39', '田中会計事務所 / 代表税理士', '補助金・資金繰りが専門。経営者仲間を探しています。', 'area|東京', 'job|士業', ['顧客紹介', '協業', '情報交換'], ['ノウハウ提供', '資金・出資'], 5200],
        ['渡辺 大輔', '31', '渡辺製作所 / 工場長', '金属加工・小ロット試作が得意。仕入先も探しています。', 'area|愛知', 'job|製造', ['仕入・調達', '販路開拓'], ['技術・開発'], 300],
        ['伊藤 彩', '44', 'いとう訪問看護 / 管理者', '医療福祉の現場を良くしたい。人材・連携を募集。', 'area|神奈川', 'job|医療・福祉', ['採用・人材', '仲間づくり'], ['ノウハウ提供'], 1800],
        ['山本 拓也', '37', '山本商店 / 店主', '飲食2店舗経営。販路とコラボ相手を探しています。', 'area|北海道', 'job|飲食', ['販路開拓', '顧客紹介'], ['仕入・調達'], 120],
        ...
        ['加藤 遥', '41', '加藤人材サービス / 取締役', '採用・人材紹介ならお任せを。良い会社を増やしたい。', 'area|大阪', 'job|教育', ['採用・人材', '協業'], ['採用・人材'], 4300],
        ['吉田 淳', '46', '吉田建設 / 専務', '公共・民間工事。協力会社と資材の調達先を募集。', 'area|広島', 'job|建設', ['仕入・調達', '販路開拓'], ['顧客紹介'], 700],
