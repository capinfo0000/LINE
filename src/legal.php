...
# {条}（入会・会員資格）
1. {入会の流れ}
2. 会員資格の維持には、当方が定める場合に月額会費（サブスクリプション）のお支払いが必要です。
3. 当方は、必要と判断した場合、入会をお断りし、または会員資格を停止・取り消すことがあります。
...
3. 会員はいつでも解約でき、解約後は次回以降の請求が停止します。お支払い済みの月額会費の返金は、[キャンセル・返金ポリシー](/policy.php)に定める場合を除き、原則としてお受けできません（当月分の日割り返金は行いません）。
